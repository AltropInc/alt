...
## Level 0 Expressions (Primary Expressions)
...
## Level 1 Expressions (Postfix Expressions)
...
* a cast expression to cast the value of an expression to a value of another type
...
&nbsp;&nbsp;&nbsp;&nbsp;cast(*type-expression*, *expression*)<br>
...
## Level 2 Expressions (Prefix Expressions)
...
## Level 3 ~ 13 Compound Expressions
