...
#define  ALT_OS_FAMILY_MAC      2
#define  ALT_OS_FAMILY_BSD      3
#define  ALT_OS_FMAIL_WINDOWS   4

// TODO The following two definitions should be defeined in CMAKE. Define here of
//  VS Code error delection only
//#define __CYGWIN__;
//#define _GNU_SOURCE;
    ...
    #define ALT_UNDERLYING_OS   ALT_OS_ANDRIOD
#elif defined (__linux__)
    #define ALT_OS              ALT_OS_LINUX
    #define ALT_OS_FAMILY       ALT_OS_FAMILY_LINUX
    #define ALT_UNDERLYING_OS   ALT_OS_LINUX
    ...
    #endif
    #define ALT_UNDERLYING_OS   ALT_OS_WINDOWS
#elif defined (__APPLE__)
    #define ALT_OS              ALT_OS_MAC_OS_X
    #define ALT_OS_FAMILY       ALT_OS_FAMILY_MAC
    #define ALT_UNDERLYING_OS   ALT_OS_MAC_OS_X
...
// C++ attributes
    ...
    #define ALT_CPP_VERSION_20
#elif (__cplusplus >= 201703L)
    #define ALT_CPP_VERSION_17
#else
...
#define CHAR_BIT                8
#define ALT_CHAR_BIT            32
#define alt_char_t              char32_t
